...
- Charts: `deploy/helm/{manager,operator}` (version `v0.1.3`)
...
## Roadmap & changes
- Roadmap: `ROADMAP.md` or `docs/roadmap.md` (v0.1.3 baseline, live API E2E, docs refresh).
- Changelog: `CHANGELOG.md` (current release v0.1.3).
