...
func (f *fakeVelaDelete) DeleteApp(context.Context, string, string) error { f.called = true; return nil }
func (f *fakeVelaDelete) GetApp(context.Context, string, string) (map[string]any, error) { return nil, nil }
...
func (f *fakeVelaDelete) Status(context.Context, string, string) (map[string]any, error) { return nil, nil }
func (f *fakeVelaDelete) Revisions(context.Context, string, string) ([]map[string]any, error) { return nil, nil }
func (f *fakeVelaDelete) Diff(context.Context, string, string, int, int) (map[string]any, error) { return nil, nil }
func (f *fakeVelaDelete) Logs(context.Context, string, string, string, bool) ([]map[string]any, error) { return nil, nil }
func (f *fakeVelaDelete) SetTraits(context.Context, string, string, []map[string]any) error { return nil }
func (f *fakeVelaDelete) SetPolicies(context.Context, string, string, []map[string]any) error { return nil }
func (f *fakeVelaDelete) ImageUpdate(context.Context, string, string, string, string, string) error { return nil }
...
func TestAppDeleteActionInvokesBackend(t *testing.T) {
  ...
  if resp.StatusCode != http.StatusAccepted { t.Fatalf("status: %s", resp.Status) }
  resp.Body.Close()
  if !fv.called { t.Fatalf("backend delete not called") }
}
