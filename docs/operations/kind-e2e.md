...
- Optional: build local `ghcr.io/vaheed/kubenova/*:0.1.1` images if you want to `kind load` them (`LOAD_IMAGES=1`)
...
# Optional: LOAD_IMAGES=1 IMAGE_TAG=0.1.1 ./kind/e2e.sh   # also loads local images into kind
```
