...
- Optional: build local `ghcr.io/vaheed/kubenova/*:v0.1.3` images if you want to `kind load` them (`LOAD_IMAGES=1`)
...
# Optional: LOAD_IMAGES=1 IMAGE_TAG=v0.1.3 ./kind/e2e.sh   # also loads local images into kind
```
